...
//Form
$_['form_title_main']                         = 'Сформировать комплект с консультантом:';
$_['form_text']                         	  = '<p>Сертифицированный специалист</p><p>перезвонит вам в течении 3-х минут и </p><p>поможет подобрать оборудование и </p><p>комплектацию специально для</p><p>вашего объекта.</p>';
$_['form_title_bottom']                       = 'Все консультации бесплатны!';
$_['form_hidden']                       	  = 'Форма карточка товара: Обратиться к консультанту';
