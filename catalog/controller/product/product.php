	...
	public function index() {
		...
		if ($product_info) {
				...
				foreach ($option['product_option_value'] as $option_value) {
					if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
						...
						$product_option_value_data[] = array(
							...
							'o_checked'               => html_entity_decode($option_value['o_checked']),
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/form/woman_consultant.tpl')) {
				$data['form_consultant'] = $this->load->view($this->config->get('config_template') . '/template/form/woman_consultant.tpl', $data);
			}else{$data['form_consultant'] = '';}

			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/form/credit.tpl')) {
				$data['form_credit'] = $this->load->view($this->config->get('config_template') . '/template/form/credit.tpl', $data);
			}else{$data['form_credit'] = '';}
