    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
          ...
          <ul class="thumbnails">
            ...
            <li class="main-img">
                <a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>">
                  ...
                  <img src="image/zoom.png" width="30" height="30" alt="<?php echo 'alt '.$heading_title; ?>" title="<?php echo 'title '.$heading_title; ?>" class="img-zoom-product" />
                </a>
            </li>
            <?php } ?>
          </ul>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div class="rating">
            <p>
              <img class="starsCard" data-vote="<?php echo $vote; ?>" src="image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
              <a href='#' id="reviews_text" data-id="<?php echo $product_id; ?>"><?php echo $reviews; ?></a>
               / <a href="#vk_comments" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $text_write; ?></a></p>
            <!-- <hr> -->
          ...
          <?php echo $form_credit;?>
          <?php if ($price) { ?>
          <ul class="list-unstyled">
            <?php if (!$special) { ?>
            <li>
			<?php $p = str_replace(' грн', '', $price); ?>
              <h2 class="main_price" data-price="<?php echo $price; ?>">
                <?php
                  $reverse = strrev($p);
            ...
            <li>
              <button type="button" data-target="#credit" data-toggle="modal" class="btn installment">Рассрочка</button>
            </li>

            <li>
              <img src="image/phone.png" data-toggle="modal" data-target="#myCCTV" width="30" height="30" alt="alt обратный звонок" title="title обратный звонок" class="img-callback prd-modal">
            </li>
          ...
          <div id="product">
            ...
            <?php if ($option['type'] == 'select') { ?>
              ...
              <div class="form-group options_selects">
                <label class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
                <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($option['product_option_value'] as $option_value) { ?>
                    <?php if($option_value['o_checked']==1){ ?>
                    <option data-price-select="<?php echo str_replace(' грн', '', $option_value['price']);?>" selected="selected" value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
                    <?php if ($option_value['price']) { ?>
                    (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                    <?php } ?>
                    </option>
                    <?php }else{ ?>
                      <option  data-price-select="<?php echo str_replace(' грн', '', $option_value['price']);?>" value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
                      <?php if ($option_value['price']) { ?>
                      (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
                      <?php } ?>
                      </option>
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                <div class="checkbox options_checkboxes">
              <!--  <label>
                  ...
                  <?php echo $option_value['o_description'] ?>
                </div>
                <?php } ?>
              </div>
            </div>
            ...
            <?php if(!$options){ ?>
              ...
              <!--  <label class="control-label" for="input-quantity"><?php echo $entry_qty; ?></label> -->
               ...
               <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
               <br />
               <button type="button" id="button-cart" class="buy-btn btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button>
             </div>
           <?php } ?>
            <?php if ($minimum > 1) { ?>
          ...
          <div class="product_consultant"><?php echo $form_consultant;?></div>
        </div>
      </div>
	
	  <?php if ($short_description) { ?>	
		<div class="container"><?php echo $short_description;?></div>
	  <?php } ?>	
  ...
  var offset = $(this).offset(),
   ...
   var pos = find(idn);
     ...
     if(pos !== -1){
          ...
          return;
     }else{ $.cookie('rating', products, {expires: 30, path: '/'});}
...
$(document).ready(function() {
	$('.thumbnails,.product_carousel').magnificPopup({
		type:'image',
		delegate: 'a',
		gallery: {
			enabled:true
