    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-categories"><?php echo $entry_change_categoty; ?></label>
            <div class="col-sm-10">
              <select name="name_category" id="input-categories" class="form-control">
                <?php foreach($categories_name as $item){ ?>
					<?php if($name_category == $item['category_id']){ ?>
