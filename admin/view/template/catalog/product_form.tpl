        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-length"><?php echo $entry_block_rating; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="votes" value="<?php echo $votes; ?>" placeholder="<?php echo $entry_votes; ?>" id="input-votes" class="form-control" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-option">
              <div class="row">
                ...
                <td class="text-left"><?php echo $entry_option_description; ?></td>
                <td class="text-left"><?php echo $entry_option_checked; ?></td>  
                ...
                <td><textarea name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][o_description]" cols="30" rows="2"><?php echo $product_option_value['o_description']; ?></textarea></td>
                <td><input type="checkbox" <?php if($product_option_value['o_checked'] ==1){echo "checked='checked'";}else{echo '';}?> value="1" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][o_checked]"></td>
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-left"><?php echo $entry_option_value; ?></td>';
                ...
                html += '<td class="text-left"><?php echo $entry_option_description; ?></td>';
                html += '<td class="text-left"><?php echo $entry_option_checked; ?></td>';
			...
			html += '    <tfoot>';
			html += '      <tr>';
			html += '        <td colspan="7"><td colspan="8"></td>';
...
function addOptionValue(option_row) {	
	...
	html += '  </select><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][product_option_value_id]" value="" /></td>';
                ...
                html += '  <td><textarea name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][o_description]" cols="30" rows="2"></textarea></td>';
                html += '  <td><input type="checkbox" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][o_checked]"></td>';
