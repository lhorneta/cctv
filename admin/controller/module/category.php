...
class ControllerModuleCategory extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_setting_setting->editSetting('name_category', $this->request->post);
		...
		$data['entry_change_categoty'] = $this->language->get('entry_change_categoty');
		...
		if (isset($this->request->post['name_category'])) {
			$data['name_category'] = $this->request->post['name_category'];
		} else {
		...
		$categories_name = $this->model_catalog_category->getCategories();
