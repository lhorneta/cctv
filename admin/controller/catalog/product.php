...
class ControllerCatalogProduct extends Controller {
	...
	public function index() {
		...
		$this->load->language('catalog/desc');
	...
	protected function getForm() {
		...
		$data['entry_block_rating'] = $this->language->get('entry_block_rating');
		$data['entry_rating'] = $this->language->get('entry_rating');
		$data['entry_votes'] = $this->language->get('entry_votes');	
        ...
        $data['entry_option_checked']       = $this->language->get('entry_option_checked');
		...
		if (isset($this->request->post['rating']) && isset($this->request->post['votes'])) {
		
			$data['rating'] = $this->request->post['rating'];
			$data['votes'] 	= $this->request->post['votes'];
			
		} elseif (isset($this->request->get['product_id'])) {
		
			$votes_info = $this->model_catalog_product->getProductRating($this->request->get['product_id']);

			if ($votes_info) {
				$data['rating'] = $votes_info[0]['rating'];
				$data['votes'] 	= $votes_info[0]['vote'];
			} else {
				$data['rating'] = '';
				$data['votes'] 	= '';
			}
